...
//    4 3 2 1 0
    ...
    /*
	othoba ami auto diye position ber kore * diye value ber korte parbo..eivabe korle last element endpoint kina ta ber kora jabe..
	like- auto it=os.lower_bound(7) then
	if(it==os.end()) cout<<"no value found\n";
	else cout<<*it<<endl;
	upper_bound er khetreo same way apply kora jabe
    */

    // 23. what is the smallest number which is greater than to a given number(7)
    cout << *os.upper_bound(7) << "\n";
    /*
    less_equal er modde lower_bound er kaj kore upper_bound
    less_equal er modde kono number delete korar way:
    auto it= os.upper_bound(5)
    os.erase(it)
    */
